...
\begin{table}[h]
    ...
    \caption{Timeline of Great Famine Root Cause Academic Discussion}
		\begin{tabular}{lp{5cm}p{5cm}}
			...
			& (3) & \\
			1852 \textendash\ Ignore Period &  & \citep{kinealy2017great} \\
			1940 \textendash\ Revisionism &  &  \\
			1975 \textendash\ Nowadays & Malthus population theory & \\
			& & \\
			& Anti-Malthus theory & \\
			& & \\
		...
		\begin{tablenotes}
			...
			\item[b] \textit{Until the 1990s, however, the two standard books on the Famine were ``The Great Famine: Studies in Irish History'' by Robin Dudley Edwards and Desmond Williams,  and ``The Great Hunger'', by Cecil Woodham-Smith, [\ldots] The chapters were uneven in quality and lacked coherence (some lacked footnotes, one set having been lost in a London taxi-cab by one of the editors).} \citep{kinealy2017great}
		\end{tablenotes}
	\end{threeparttable}
\end{table}
