...
\begin{table}[h]
    ...
    \caption{Timeline of Great Famine Root Cause Academic Discussion}
		\begin{tabular}{lp{5cm}p{5cm}}
			...
			& & \\
			1960 \textendash\ 1990: revisionism & Focus on history and event itself, ignore outside force & \citep{daly2006revisionism} \\
			& & \\
			1990s: post-revisionist & Emotional description also blame UK government & \citep{hamera2011outline} \\
			& & \\
			1990s: diverse & Malthus population theory & \citep{o2009food} \& \citep{mcgregor1989demographic} \& \citep{weir1991malthus} \\
			& &  \\
		...
		\begin{tablenotes}
			...
			\item[b] The famine seems to have been forgotten, not only was the quantity and quality of work on the famine sparse, but it was also of poor quality: \textit{Until the 1990s, the two standard books[\ldots] The chapters were uneven in quality and lacked coherence (some lacked footnotes, some were lost).} \citep{kinealy2017great}
		\end{tablenotes}
	\end{threeparttable}
\end{table}
\newpage
