...
As Amartya put it in his book \textendash\ ``\textit{the most common approach to famines is to propose explanations in terms of food availability decline (FAD)}'' \citep{sen1982poverty} \textendash\ In the Irish famine, where the FAD theory contains two aspects: (1) the potato late blight; (2) the monocultural structure of the Irish diet. In historical fact, however, while the existence of both is undeniable, their impact is not decisive.

Firstly, potato late blight. During the middle 19th century,  potato late blight was directly associated with famine due to the most intuitive empirical observations and direct logical extrapolations. Native Irish farmers have a set of folk myths about this, believing that fairies in the sky were fighting over the potatoes, or that Fear Liath, the fog man, was at work, which led to the blight and famine \citep{bartoletti2001black}. 
