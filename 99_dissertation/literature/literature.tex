...
To sum up, we will find that most of the research on famine that abandons the FAD theory generally only takes into account one aspect of the rights method. Now let us turn our attention to a small number of studies that directly adopt the rights method.
