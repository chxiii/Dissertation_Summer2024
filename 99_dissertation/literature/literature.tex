...
Firstly, potato late blight. During the middle 19th century,  potato late blight was directly associated with famine due to the most intuitive empirical observations and logical extrapolations. Native Irish farmers have a set of folk myths about this, believing that fairies in the sky were fighting over the potatoes, or that Fear Liath, the fog man, which led to the blight and famine \citep{bartoletti2001black}. There are also frequent references in correspondence with the British government, or locally, to the relationship between late blight and death in potatoes:
